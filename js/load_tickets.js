...
export async function loadTickets() {
    try {
        ...
        const ticketsData = JSON.parse(responseText);
        ...
        return new Promise((resolve, reject) => {
            ...
            ticketsData.forEach(entry => {
                ...
                request.onerror = (event) => {
                    console.error('Error storing tickets data:', event.target.error);
                    showErrorModal('Error storing tickets data: ' + event.target.error.message);
        ...
        showErrorModal('Error loading tickets data: ' + error.message);
    }
}
